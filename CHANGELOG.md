...
### Added
- RedGate-style baseline overlay for OverviewTimeline: filled min/max band + dashed median line computed from 7 days of hourly data, with toggle checkbox + metric dropdown (cpu/memory/waits/disk_io), dark mode support, and background recompute every 6 hours
